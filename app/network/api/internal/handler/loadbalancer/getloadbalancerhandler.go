...
func GetLoadBalancerHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := loadbalancer.NewGetLoadBalancerLogic(r.Context(), svcCtx)
		resp, err := l.GetLoadBalancer(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
