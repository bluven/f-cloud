...
type IUserDo interface {
	...
	SelectByName(name string) (result []model.User, err error)
}
...
func (u userDo) Exists(name string) (result bool, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT count(1) FROM users WHERE name = ? ")
...
// SELECT * FROM @@table WHERE name = '%@name'
func (u userDo) SelectByName(name string) (result []model.User, err error) {
	var generateSQL strings.Builder
